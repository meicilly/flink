...
public class DataGeneratorSource {
    public static void main(String[] args) throws Exception {
         ...
         *     第四个： 返回的类型
         */
        org.apache.flink.connector.datagen.source.DataGeneratorSource<String> dataGeneratorSource = new org.apache.flink.connector.datagen.source.DataGeneratorSource<>(
